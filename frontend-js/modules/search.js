...
export default class Search {
    ...
    sendRequest(){
        ...
        // axios.post('/search/'+this.inputField.value)
        axios.post('/search',{searchTerm: this.inputField.value})
        .then((response)=>{
          // res.send(response)
    ...
    injectHTML(){
        ...
        <div class="search-overlay-top shadow-sm">
          <div class="container container--narrow">
            ...
            <input type="text" id="live-search-field" class="live-search-field" placeholder="What are you interested in?" name="search">
